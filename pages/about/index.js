...
export const aboutData = [
  ...
  },
  {
    ...
    info: [
      {
        title: 'UX/UI Designer - MangoesOrange Agritech',
        stage: '06-2023 - 12-2023',
      },
      {
        title: 'Web Developer - MangoesOrange Agritech',
        stage: '06-2023 - 12-2023',
      },
      {
  ...
  },
  {
    ...
    info: [
      ...
      {
        title: 'Masters In Computer Application - GEHU',
        stage: '2024',
      },
      {
    ...
    <div className='container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6'>
      ...
      <div className='flex-1 flex flex-col justify-center'>
        <motion.h2 
         ...
         exit='hidden'
         className='h2'>
          Capitivating <span className='text-accent'>Stories</span> birth magnificient designs.
        </motion.h2>
          <motion.p 
           ...
           className='hidden md:flex md:max-w-xl xl:max-w-none mx-auto xl:mx-0 mb-8'>
            <div className='flex flex-1 xl:gap-x-6'>
              ...
              <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0'>
                ...
                <div className='text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]'>Satisfied clents</div>
              </div>
               {/* Projects */}
            <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0'>
                <div className='text-2xl xl:text-4xl font-extrabold text-accent mb-2'>
            ...
            <div className='relative flex-1 '>
                ...
                <div className='text-xs uppercase tracking-[1px] leading-[1.4] max-w-[100px]'>Certification Program</div>
              </div>
            </div>
          </motion.div>
      </div>
